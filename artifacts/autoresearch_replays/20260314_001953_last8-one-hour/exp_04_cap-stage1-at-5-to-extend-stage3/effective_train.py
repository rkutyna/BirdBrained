...
NOTES = 'cap stage1 at 5 to extend stage3 | 1h replay'
...
STAGES = [{'name': 'head_only', 'unfreeze': ('fc.',), 'lr': 0.01, 'max_epochs': 5},
 {'name': 'layer4+head', 'unfreeze': ('layer4.', 'fc.'), 'lr': 0.0001, 'max_epochs': 5},
