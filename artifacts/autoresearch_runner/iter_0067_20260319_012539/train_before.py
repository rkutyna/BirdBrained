...
# --- Species mode ---
SPECIES_MODE = "subset98_combined"  # set by autorun.py --species
...
if SPECIES_MODE == "full555":
    ...
    CACHE_PKL = ARTIFACTS_DIR / "autoresearch_splits_base_species.pkl"
    LABEL_NAMES_CSV = ARTIFACTS_DIR / "label_names_nabirds_base_species.csv"
    LOG_CSV = ARTIFACTS_DIR / "autoresearch_log_base_species.csv"
    BEST_CKPT = ARTIFACTS_DIR / "autoresearch_best_base_species.pt"
elif SPECIES_MODE == "base_combined":
    CACHE_PKL = ARTIFACTS_DIR / "autoresearch_splits_base_combined.pkl"
    LABEL_NAMES_CSV = ARTIFACTS_DIR / "label_names_nabirds_base_species.csv"
    LOG_CSV = ARTIFACTS_DIR / "autoresearch_log_base_combined.csv"
    BEST_CKPT = ARTIFACTS_DIR / "autoresearch_best_base_combined.pt"
elif SPECIES_MODE == "subset98_combined":
    CACHE_PKL = ARTIFACTS_DIR / "autoresearch_splits_subset98_combined.pkl"
    LABEL_NAMES_CSV = ARTIFACTS_DIR / "label_names.csv"
    LOG_CSV = ARTIFACTS_DIR / "autoresearch_log_subset98_combined.csv"
    BEST_CKPT = ARTIFACTS_DIR / "autoresearch_best_subset98_combined.pt"
else:
